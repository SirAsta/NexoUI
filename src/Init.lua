...
--local ServicesModule = NexoUI.Services
...
function NexoUI:CreateWindow(Config)
	...
	--     NexoUI.Transparent = Value
	--     NexoUI.Window.Transparent = Value

	--     Window.UIElements.Main.Background.BackgroundTransparency = Value and NexoUI.TransparencyValue or 0
	--     Window.UIElements.Main.Background.ImageLabel.ImageTransparency = Value and NexoUI.TransparencyValue or 0
