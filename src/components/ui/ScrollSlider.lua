...
function ScrollSlider.New(ScrollingFrame, Parent, Window, Thickness, NexoUI)
	...
	local function StopDrag()
		if NexoUI.CurrentInput == ScrollSliderActionId then
	...
	Creator.AddSignal(Hitbox.InputBegan, function(input)
		...
		if NexoUI.CurrentInput and NexoUI.CurrentInput ~= ScrollSliderActionId then
			return
		end

		NexoUI.CurrentInput = ScrollSliderActionId
